    ...
    <article class="cards">
        <?php if (isset($_SESSION['role'])) : ?>
            <div class="del-creat-cont">
                <img src="./assets/img/logos/icon_croix_bx.svg" alt="icon des suppression" class="btn-del" data-id="<?php echo $cards->id_bottle ?>">
...
<ul class="navigation">
    ...
    <?php if ($current_page == 1) : ?>
        <li class="disabled"><a href="#"><i class="fas fa-chevron-left"></i></a></li>
    <?php else : ?>
        <li class="wave-effect"><a href="blanc.php?page=<?php echo $current_page - 1; ?>"><i class="fas fa-chevron-left"></i></a></li>
    <?php endif; ?>
    ...
    for ($i = 1; $i <= $nb_pages; $i++) : ?>
        ...
        <?php if ($i == $current_page) : ?>
            <li class="active"><a><?php echo $i; ?></a></li>
        <?php else : ?>
            <li class="wave-effect"><a href="blanc.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php endif; ?>
    ...
    <?php if ($current_page == $nb_pages) : ?>
        <li class="disabled"><a href="#"><i class="fas fa-chevron-right"></i></a> </li>
    <?php else : ?>
        <li class="wave-effect"><a href="blanc.php?page=<?php echo $current_page + 1; ?>"><i class="fas fa-chevron-right"></i></a></li>
    <?php endif; ?>
</ul>